                ...
                <div class="modal-body">
                    ...
                    <ul id="shoppingCart">
                        <li v-for="(machine, index) in shoppingCart" :key="machine.id">
                            ...
                            ({{machine.quantity}})
                            <span id="shopping">Price:</span> $ {{machine.price*machine.quantity}}<span><i
                                    class="fa fa-trash-o" id="deletBtn"
                                    @click=" removeMachine(index)"></i></span></li>
                        <hr>
                        <li> <span id="shopping">Total Price:</span> $ {{totalPrice}} </li>
