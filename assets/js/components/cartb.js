                    ...
                    <div id="border">
                        <ol id="shoppingCart">
                            <li v-for="(bean, index) in shoppingCartB" :key="bean.id" >
                                <span id="shopping">Name:</span>{{bean.name}}<br>
                                <span id="shopping">Quantity:</span>({{bean.quantity}})<br>
                                <span id="shopping">Price:</span>
                                <span v-if="bean.onSale30">
                                    <span class="newPrice30"> <b>$ {{(bean.price - (bean.price * 30 / 100))*bean.quantity}}</b>
                                        <span id="saleBorder">Sale 30%</span>
                                    </span>
                                </span>
                                <span v-else-if="bean.onSale50">
                                    <span class="newPrice50"> <b>$ {{(bean.price - (bean.price * 50 / 100))*bean.quantity}}</b>
